# tf-az-module-storage-account (Azure Storage Account)
...
| <a name="input_location"></a> [location](#input\_location) | (Required) The Azure Region where the Resource Group and storage Account should exist. Changing this forces a new Resource Group and storage Account to be created. | `string` | n/a | yes |
| <a name="input_name"></a> [name](#input\_name) | (Required) The Name which should be used for this storage account. Changing this forces a new storage account to be created. | `string` | n/a | yes |
